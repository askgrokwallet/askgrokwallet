#!/usr/bin/env node
// grokbotwallet plugin — local structure validation
...
if (!skillText.includes("name: grokbotwallet")) fail("SKILL.md missing frontmatter name");
...
if (manifest.name !== "grokbotwallet") fail("plugin.json name mismatch");
...
if (cursorManifest.name !== "grokbotwallet") fail("cursor plugin.json name mismatch");
